    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          provider.dailyCheckListFormDetails.isNotEmpty
              ? Padding(
                  padding:
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              provider.dailyCheckListFormDetails[0]['eqpt'],
                              style: CommonTheme.headingOne1,
                            ),
                          ],
                        ),
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            Text(
                              provider.dailyCheckListFormDetails[0]['project'],
                              style: CommonTheme.headingOne1,
                            ),
                          ],
                        ),
                                          ...
                                          (e) => Column(
                                            ...
                                            children: [
                                              Container(
                                                ...
                                                child: Text(
                                                  "${provider.checkListData.indexOf(e) + 1}.  ${e['title']}  ",
                                                  ...
                                                  .map(
                                                    (innerData) => Padding(
                                                      ...
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          Text(
                                                            "${provider.checkListData.indexOf(e) + 1}.${e['data'].indexOf(innerData) + 1} ${innerData['name']}",
                                                            maxLines: 2,
                                                            overflow:
                                                                TextOverflow
                                                                    .ellipsis,
            ...
            child: ElevatedButton(
              ...
              onPressed: () {
                if (vehicleIdDefaultId == "") {
                  ...
                  Map requiredData = {
                    "machine_id": provider.dailyCheckListFormDetails[0]
                        ['machine_id'],
                  ...
                  provider.submitDailyCheckListFormData(context, requiredData);
                }
              },
              child: Text('Submit'),
            ),
